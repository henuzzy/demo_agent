...
# inspect 是 Python 的标准库，用来做 代码反射 / 结构分析（查看对象有什么方法、属性等）。
import inspect
import re

def tool_action(name: str | None = None, description: Optional[str] = None):
...
class Tool(ABC):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # model_dump: 把 Pydantic 模型实例 → 转成Python字典
